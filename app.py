...
BASE_DRL = os.path.dirname(os.path.abspath(__file__))
...
def init_log_config():
    ...
    # logfile = BASE_DRL + os.sep + "log" + os.sep + "p2p{}.log".format("%Y%m%D %H%M%S")
    logfile = BASE_DRL + os.sep + "log" + os.sep + "p2p.log"
